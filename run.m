...
evaluation(evaluation_name, {'journal', ...
                             'journal-ordered', ...
                             'journal-minyear'}, false)


%% authors 'author-ordered-minyear-recursive', 'author-ordered-minyear'
evaluation(evaluation_name, {'author', ...
                             'author-ordered-recursive', ...
                             'author-ordered', ...
                             'author-recursive'})


%% conferences
evaluation(evaluation_name, {'conference', ...
                             'conference-ordered', ...
                             'conference-ordered-minyear'})
...
%%
evaluation(evaluation_name, {'author', ...
                             'author-ordered-minyear-recursive', ...
                             'author-ordered-minyear-recursive+journal-ordered-minyear', ...
                             'journal', ...
                             'journal-minyear', ...
                             'journal-ordered'}, false)